...
class NetworkManager {
    ...
    static func networkRequest(_ searchWord: String = "search", completionHandlerAfter: @escaping(AllItems) -> Void) {
        ...
        let searchItem = searchWord.replacingOccurrences(of: " ", with: "%20")
        ...
        let request = NSMutableURLRequest(url: NSURL(string: "https://mashape-community-urban-dictionary.p.rapidapi.com/define?term=\(searchItem)")! as URL,
